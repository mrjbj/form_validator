defmodule FormValidatorWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: FormValidatorWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/form_validator_web/templates",
        namespace: FormValidatorWeb
